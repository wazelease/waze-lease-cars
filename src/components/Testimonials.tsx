...
const testimonials = [
  {
    ...
    text: "השירות של Waze Lease Cars הוא ברמה אחרת לגמרי. קיבלתי הצעה מעולה על BMW X5 תוך יום אחד. מנהל הלקוח שלי זמין תמיד ומטפל בהכל.",
    rating: 5,
  },
  {
    name: "מיכל לוי",
    role: "עורכת דין",
    text: "אחרי שנים עם חברות ליסינג אחרות, עברתי ל-Waze Lease Cars ולא מסתכלת אחורה. המחירים טובים יותר, השירות אישי, והתהליך היה חלק.",
    rating: 5,
  },
  {
    name: "אבי ישראלי",
    role: "בעל עסק",
    text: "לקחנו ליסינג ל-12 רכבים לחברה. החיסכון השנתי שלנו הוא עשרות אלפי שקלים. השירות המקצועי עושה את ההבדל.",
    rating: 5,
  },
  {
    name: "נועה ברק",

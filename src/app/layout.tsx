...
export const metadata: Metadata = {
  ...
  description:
    "חברת הליסינג המובילה בישראל. מבחר רכבים חדשים במחירים הטובים ביותר, שירות אישי ומקצועי. ליסינג פרטי, תפעולי ומימוני. ראשון לציון.",
  keywords:
    "ליסינג, ליסינג רכב, ליסינג פרטי, ליסינג תפעולי, ליסינג מימוני, השכרת רכב, רכב חדש, ישראל, ראשון לציון, ליסינג ראשון לציון, Waze Lease Cars",
  openGraph: {
    title: "Waze Lease Cars | ליסינג רכב פרימיום בישראל",
    description:
      "חברת הליסינג המובילה בישראל. שירות פרימיום, מחירים תחרותיים, ליסינג פרטי תפעולי ומימוני.",
    locale: "he_IL",
    type: "website",
...
const jsonLd = {
  ...
  description:
    "חברת ליסינג רכב פרימיום בישראל. ליסינג פרטי, תפעולי ומימוני במחירים הטובים ביותר.",
